...
class Gender(models.Model):
    ...
    gender = models.CharField(max_length=55, blank=False) #gender VARCHAR(55) NOT NULL - sql equivalent
    date_created = models.DateTimeField(auto_now_add=True) # TIMESTAMP DEFAULT CURRENT TIMESTAMP
